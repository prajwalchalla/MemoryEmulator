...
# Save clusters and node IDs to a file
with open(f'{test_out_dir}/clusters_nodes.txt', 'w') as cluster_file:
    for node, comm in node2comm.items():
        cluster_file.write(f"{node} {comm}\n")
...
#plt.savefig(f'{test_out_dir}/clustering-sw4lite.pdf', bbox_inches="tight", dpi=1000, facecolor='w')
